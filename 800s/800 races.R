...
# Import data sets
spire.2017 <- read.csv("~/GitHub/workouts/800s/spire (1).csv")
mount.union.2017 <- read.csv("~/GitHub/workouts/800s/Mount Union 2017 (1).csv")
tiffin.2017 <- read.csv("~/GitHub/workouts/800s/tiffin 2017.csv")
kenyon.2017 <- read.csv("~/GitHub/workouts/800s/kenyon 2017.csv")
gator.2017 <- read.csv("~/GitHub/workouts/800s/gator 2017.csv")
