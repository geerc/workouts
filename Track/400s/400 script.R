...
# Import data sets
spire.2017 <- read.csv("~/workouts/Track/400s/spire.csv")
ashland.2017 <- read.csv("~/workouts/Track/400s/ashland.csv")
conferences.2017 <- read.csv("~/workouts/Track/400s/conferences.csv")
wooster.2018 <- read.csv("~/workouts/Track/400s/wooster.csv")
...
names(all.workouts)[names(all.workouts) == "Time.x.x"] <- "Conferences 2017"
names(all.workouts)[names(all.workouts) == "Time.y.y"] <- "Wooster 2018"
