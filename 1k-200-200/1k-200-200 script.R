...
aug.30.2016 <- read.csv("~/workouts/1k-200-200/Aug 30 2016.csv")
sep.12.2017 <- read.csv("~/workouts/1k-200-200/Sep 12 2017.csv")
...
all.workouts.plot <- all.workouts %>% gather(`Aug 30 2016`,
                                             `Sep 12 2017`,
                                             `Sep 13 2016`,
                                             key = "Date",
                                             value = "Time") %>% 
