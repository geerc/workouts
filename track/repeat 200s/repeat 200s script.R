...
names(all.workouts)[names(all.workouts) == "Time"] <- "Dec 16 2017"

# Make new data table optimized for plotting
all.workouts.plot <- all.workouts %>% gather(`Dec 9 2016`, `Dec 23 2016`, `Jan 5 2017`, `Mar 3 2017`, `Mar 21 2017`, `Dec 7 2017`, `Dec 16 2017`, key = "Date", value = "Time")
